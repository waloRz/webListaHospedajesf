    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between h-16 gap-6">
            ...
            >
              {/* Ícono de montaña desde imagen */}
              <img
                src="/img/montain.webp"
                alt="Montaña"
             ...
             group-hover:scale-110"
              ...
              <span className="font-display leading-none">
                ...
                <span
                  className="text-noche text-[17px] tracking-tight
      ...
      >
            ...
            >
              {({ isActive }) => (
                <>
                  {/* Ícono de la sección */}
                  <span
                    className={`shrink-0 transition-colors ${isActive ? "text-white" : "text-white/50"}`}
                  >
                    {icono}
                  </span>
                  {/* Label */}
        ...
        <div className="px-5 py-5 border-t border-black/10">
          ...
          >
            <div
              className="w-8 h-8 rounded-lg bg-white/15
